...
import { Cpu, ShieldCheck, Mail, Lock, User, ChevronRight } from "lucide-react";
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-slate-900 border border-slate-800 p-8 rounded-2xl space-y-6 shadow-2xl">
          ...
          <div className="text-center space-y-1.5">
            ...
            <p className="text-xxs text-slate-500 font-mono uppercase tracking-wider">Start semantic applicant profiling</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xxs font-bold text-slate-400 uppercase tracking-wider block font-mono">Full Name</label>
          ...
          <div className="text-center pt-2">
            <span className="text-xxs text-slate-500 hover:text-slate-400 cursor-pointer" onClick={() => router.push("/login")}>
              Already have an account? <strong className="text-cyan-400">Sign In</strong>
            </span>
          </div>
